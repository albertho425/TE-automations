function onFormSubmit(e) {
  ...
  try {
    ...
    // Append response to the master tab (Form Responses 3)
    var masterSheet = spreadsheet.getSheetByName("Form Responses 3");
    if (!masterSheet) {
      throw new Error("Master sheet 'Form Responses 3' not found");
    }
